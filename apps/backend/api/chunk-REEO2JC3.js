...
`)}}),g()],databaseHooks:{session:{create:{after:async e=>{let{recordActivity:o}=await import("./audit-2CD4ID23.js");await o({userId:e.userId,action:"USER_LOGIN",ipAddress:e.ipAddress??void 0,userAgent:e.userAgent??void 0})}}}}});export{P as a};
